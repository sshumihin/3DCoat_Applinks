...
// Executed Thu Sep 23 00:14:49 UTC+0700 2010 by sshadows
// 
...
XSIPLUGINCALLBACK CStatus siOnActivateEvent_OnEvent( CRef& in_ctxt )
{
...
XSIPLUGINCALLBACK CStatus Export3DCoatMenu_Init(CRef& in_ctxt)
{
	Context ctxt( in_ctxt );
...
XSIPLUGINCALLBACK CStatus Import3DCoatMenu_Init(CRef& in_ctxt)
{
	Context ctxt( in_ctxt );
...
XSIPLUGINCALLBACK CStatus AppLink_3DCoat_Init( CRef& in_ctxt )
{
	Context ctxt( in_ctxt );
...
XSIPLUGINCALLBACK CStatus coatClicked( CRef& in_ref)
{	
