...
XSIPLUGINCALLBACK CStatus AppLink_3DCoat_Define( CRef& in_ctxt )
{
...
XSIPLUGINCALLBACK CStatus  AppLink_3DCoat_DefineLayout( CRef& in_ctxt )
{	
	Context ctxt(in_ctxt);
...
XSIPLUGINCALLBACK CStatus  AppLink_3DCoat_PPGEvent( const CRef& in_ctxt )
{	
	//Application app;
