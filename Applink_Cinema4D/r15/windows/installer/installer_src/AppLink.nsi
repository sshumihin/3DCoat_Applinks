...
DirText "Please choose the folder where Maxon Cinema 4D R15 and above is installed to copy 3D-Coat AppLink plugin files there."  
...
; The file to write
OutFile "ApplinkCinema4DR15win_v1.0.exe"
...
Function dirImage
	!insertmacro BIMAGE "C4DR15-header.bmp" /RESIZETOFIT
FunctionEnd

Function .onInit
	${If} ${RunningX64}
	StrCpy $INSTDIR "$PROGRAMFILES64\MAXON\CINEMA 4D R15\plugins"
	${Else}
	StrCpy $INSTDIR "$PROGRAMFILES32\MAXON\CINEMA 4D R15\plugins"
	${EndIf}
