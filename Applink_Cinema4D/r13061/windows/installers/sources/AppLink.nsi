...
DirText "Please choose the folder where Maxon Cinema 4D R13.061 and above is installed to copy 3D-Coat AppLink plugin files there."  
...
; The file to write
OutFile "ApplinkCinema4DR13061win_v1.2.exe"
...
;InstallDir "$INSTDIR\MAXON\CINEMA 4D R13\plugins"
...
Function dirImage
	!insertmacro BIMAGE "C4DR13-header.bmp" /RESIZETOFIT
FunctionEnd

Function .onInit
	${If} ${RunningX64}
	StrCpy $INSTDIR "$PROGRAMFILES64\MAXON\CINEMA 4D R13\plugins"
	${Else}
	StrCpy $INSTDIR "$PROGRAMFILES32\MAXON\CINEMA 4D R13\plugins"
	${EndIf}
