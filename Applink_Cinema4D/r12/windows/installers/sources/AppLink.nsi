...
DirText "Please choose the folder where Maxon Cinema 4D R12 is installed to copy 3D-Coat AppLink plugin files there."  
...
; The file to write
OutFile "ApplinkCinema4DR12win_v1.2.exe"
...
Function dirImage
	!insertmacro BIMAGE "C4DR12-header.bmp" /RESIZETOFIT
FunctionEnd

Function .onInit
	${If} ${RunningX64}
	StrCpy $INSTDIR "$PROGRAMFILES64\MAXON\CINEMA 4D R12\plugins"
	${Else}
	StrCpy $INSTDIR "$PROGRAMFILES32\MAXON\CINEMA 4D R12\plugins"
	${EndIf}
